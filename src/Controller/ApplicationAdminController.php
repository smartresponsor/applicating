...
final class ApplicationAdminController extends AbstractController
{
    ...
    public function index(ApplicationRepository $applicationRepository, ApplicationReportServiceInterface $applicationReportService): Response
    {
        $this->denyAccessUnlessGranted('ROLE_APPLICATION_VIEWER');

        return $this->render('application/index.html.twig', [
            'applications' => $applicationRepository->findOrderedForAdmin(),
